...
Relay documents may contain private project context. Review generated relay files before sharing or committing them.
...
The included `.gitignore` ignores `.relay/` by default to reduce accidental commits of generated relay documents.
