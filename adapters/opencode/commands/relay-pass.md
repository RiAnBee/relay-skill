...
Relay pass arguments: $ARGUMENTS

If the skill is not automatically loaded, read `skills/relay-pass/SKILL.md` or `.opencode/skills/relay-pass/SKILL.md` and follow its instructions.
